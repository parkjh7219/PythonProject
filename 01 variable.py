...
# 정적 타입 : 변수 선언 시 자료형도 같이 선언
# String name = "홍길동"
# name = 99 (x)

# 동적 타입 : 변수 선언 시 자료형은 생략, 추론 기능으로 자동 할당
#           또한 , 변수에 대입하는 값에 따라 자료형이 바뀜 < 파이썬은 동적
# name = '홍길동'
# name = 99 (o)

# 변수의 자료형을 알아보려면 tyoe 함수 사용
...
name = '박진환'
age = 29
email = 'parkjh7269@naver.com'
isMarried = False
money = 12000
joinDate = '2025-11-04 16:10:35'

print(userid, password, name, age)
print(email, isMarried, money, joinDate)

# 변수의 자료형 - 정수, 실수, 문자, 불
# 정수형 - 소수점 이하의 값이 없는 수
# 실수형 - 소수점 이하의 값이 있는 수 (부동소수)
